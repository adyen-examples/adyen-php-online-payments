...
<div class="status-container">
  <div class="status">
    ...
    <img src="{{ asset('img/failed.svg') }}" class="status-image" alt="failed">
    @else
    <img src="{{ asset('img/success.svg') }}" class="status-image" alt="success">
    <img src="{{ asset('img/thank-you.svg') }}" class="status-image status-image-thank-you" alt="thank you">
    @endif
